...
Vláda měla jasná data. Věděla co se stane stejně dobře jako teď ví, co se bude dít v následujících týdnech. Avšak místo přiměřených opatření se útápěla v nesmyslných hádkách a mediálních obratech.
