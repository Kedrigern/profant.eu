...
<a href="/assets/pdf/cv-ondrej-profant.pdf">
...
{{ img(src="/assets/img/bio-obrazek1.jpg", alt="alt text", title="V pirátském kostýmu", align="right") }}
...
{{ img(src="/assets/img/bio-obrazek2.jpg", alt="alt text", title="Kontaktní kampaň") }}
...
{{ img(src="/assets/img/bio-obrazek3.jpg", alt="alt text", title="Na zasedání ZHMP", align="right") }}
...
{{ img(src="/assets/img/uspechy/poslanec.jpg", alt="alt text", title="V Poslanecké sněmovně") }}
